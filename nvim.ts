...
export declare interface Nvim {
  ...
  nvim_buf_get_option: (buffer: Buffer, name: string) => Record<string, unknown>;

  nvim_buf_set_option: (buffer: Buffer, name: string, value: Record<string, unknown>) => void;
  ...
  nvim_buf_add_highlight: (buffer: Buffer, src_id: number, hl_group: string, line: number, col_start: number, col_end: number) => number;

  nvim_buf_clear_namespace: (buffer: Buffer, ns_id: number, line_start: number, line_end: number) => void;

  nvim_buf_set_virtual_text: (buffer: Buffer, src_id: number, line: number, chunks: Array<unknown>, opts: Record<string, unknown>) => number;
  ...
  nvim_get_hl_by_name: (name: string, rgb: boolean) => Record<string, unknown>;

  nvim_get_hl_by_id: (hl_id: number, rgb: boolean) => Record<string, unknown>;
  ...
  nvim_get_option: (name: string) => Record<string, unknown>;

  nvim_get_all_options_info: () => Record<string, unknown>;

  nvim_get_option_info: (name: string) => Record<string, unknown>;

  nvim_set_option: (name: string, value: Record<string, unknown>) => void;
  ...
  nvim_call_atomic: (calls: Array<unknown>) => Array<unknown>;
  ...
  nvim_win_get_option: (window: Window, name: string) => Record<string, unknown>;

  nvim_win_set_option: (window: Window, name: string, value: Record<string, unknown>) => void;
